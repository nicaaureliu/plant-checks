...
<head>
  ...
  <style>
    ...
    input, textarea, button { width: 100%; padding: 10px; border-radius: 10px; border: 1px solid #ccc; box-sizing: border-box; }
    ...
    .pill.active { outline: 3px solid #111; background:#fff; }

    /* Table */
    .tableWrap { overflow-x:auto; border:1px solid #111; border-radius:8px; }
    table { border-collapse: collapse; width: 1100px; background:#fff; }
    th, td { border:1px solid #111; padding:6px; font-size:12px; }
    th { background:#fff; }
    th.item { width: 420px; background:#ffd600; }
    td.item { font-size:11px; }
    td.day { text-align:center; width: 80px; }
    td.day.inactive { background:#fafafa; color:#bbb; }
    td.day.active { background:#fff; }
    ...
    .markBtn:disabled { cursor:not-allowed; opacity:.55; }
  ...
  <!-- jsPDF (creates the PDF in-browser) -->
  <script src="https://cdn.jsdelivr.net/npm/jspdf@2.5.1/dist/jspdf.umd.min.js"></script>
</head>

<body>
  <div class="buildTag" id="buildTag">BUILD: v6</div>
  ...
  <div class="card">
    ...
    <div class="sheetTitle" id="sheetTitle">Plant Pre-use Inspection Checklist</div>
    ...
    <p class="small" id="tokenPreview" style="margin:6px 0 0;">Token: —</p>
  </div>
  ...
  <div class="card">
    ...
    <p class="small">Only the column for your selected date is active. Tap the box to cycle ✓ / X / N/A.</p>
  ...
  <!-- IMPORTANT: bump ?v= whenever you change app.js (stops caching issues) -->
